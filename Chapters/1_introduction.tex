...
\end{equation}
where the longitudinal velocity $v_x$ is the component of the velocity vector along the $x_v$ axis, the lateral velocity $v_y$ is the component of the velocity vector along the $y_v$ axis and the vertical velocity $v_z$ is the component of the velocity vector along the $z_v$ axis. From now on the longitudinal speed will refer to the magnitude of the longitudinal velocity component, that is:
\begin{equation}
    v_{long} = v_x.
\end{equation}
